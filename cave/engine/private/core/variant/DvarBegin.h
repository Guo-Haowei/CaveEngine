...
#define DVAR_VEC2(name, flags, desc, x, y)        (DVAR_##name).registerVec2f(#name, x, y)
#define DVAR_VEC3(name, flags, desc, x, y, z)     (DVAR_##name).registerVec3f(#name, x, y, z)
#define DVAR_VEC4(name, flags, desc, x, y, z, w)  (DVAR_##name).registerVec4f(#name, x, y, z, w)
#define DVAR_IVEC2(name, flags, desc, x, y)       (DVAR_##name).registerVec2i(#name, x, y)
#define DVAR_IVEC3(name, flags, desc, x, y, z)    (DVAR_##name).registerVec3i(#name, x, y, z)
#define DVAR_IVEC4(name, flags, desc, x, y, z, w) (DVAR_##name).registerVec4i(#name, x, y, z, w)
#endif
